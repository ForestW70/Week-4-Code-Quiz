...
function createEndScreen() {
    ...
    submit.setAttribute("value", "Submit score and try again");
...
// this is how I set hiscore using local storage.
// set variable to a parsed form of our current hiscore, then run an if loop to check if either a highscore has not been submitted, or current score is greater than our stored score.
// sets up object to store data locally, adds two values to objects if true.
// after submit, reload page to play again.
function setHiscore() {
